...
Det som undersökts är om musiken är en underlättande metod för den kognitiva förmågan.
Jämväl om det hjälper inlärningen och ökar motivationen.
Kognitiva som begrepp handlar om hur hjärnan tar upp information medvetet för att sedan lagra, bearbetar och plocka fram information för senare scenarion.
...
Som \textcite{Effectsmusic} nämner så är det som när barn blir inlärda med hjälpmedel som musik.
Låtar som abc och tvätta händerna är de vanligaste.
